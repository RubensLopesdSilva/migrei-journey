...
export function AuthMigreiWheel() {
  ...
  const activePhaseData = phases.find(p => p.id === currentActivePhase);
        ...
        >
          ...
          >
            <div className="flex items-center justify-center h-full">
              <motion.div 
                className="h-11 w-11 rounded-full bg-gradient-to-br from-primary/20 to-primary/5 border-2 border-primary/20 flex items-center justify-center"
                animate={{ 
