...
export function MigreiCircle() {
  ...
  return (
    ...
    >
      {/* Phase Legend - Vertical on left */}
      <motion.div 
        className="hidden lg:flex flex-col gap-2 pt-8"
        ...
        {phases.map((phase) => {
          ...
          return (
            <motion.button
              ...
              disabled={isLocked}
              className={cn(
                "flex items-center gap-3 px-3 py-2 rounded-xl text-left transition-all duration-200 min-w-[120px]",
