...
const features = [{
  ...
  description: "Saia da incerteza com um passo de cada vez. O Ciclo Migrei guia você do despertar até sua nova carreira.",
  ...
  description: "Rotina diária de 10 minutos que transforma sua rede. Ações simples que geram conexões genuínas.",
  ...
  description: "Orientação de mentores experientes que já fizeram transições. Sessões individuais para acelerar resultados.",
...
export const LandingFeatures = () => {
  ...
  return <section id="recursos" className="relative overflow-hidden">
      {/* Section Header */}
      <div className="pt-20 md:pt-28 pb-8 md:pb-12 bg-gradient-to-b from-muted/20 to-muted/30">
